...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void findPlace (String placeName) async{
    if(placeName.length > 1){
      String autoCompleteUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapKey&sessiontoken=1234567890&components=country:et";
...
class PredictionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FlatButton(
      padding: EdgeInsets.all(0.0),
      onPressed: (){
        getPlaceAddressDetail(placePredictions.place_id, context);
      },
      child: Container(
        child: Column(
          children: [
